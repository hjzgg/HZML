...
<body>
	...
	<div class="container_16" id="main">
		...
		<div class="grid_16" id="display">
			<ul id="subNavigation">
				...
				<li><a href="randomQuestion.jsp" class="current"><img src="images/骰子.png" height="12" width="12">&nbsp;随机做题</a></li>
			</ul>
		</div>
		<div class="clear"></div>
	</div><!-- /#main -->
	...
	<div class="container_16" id="content">
		<div class="grid_16 content" id="three_col">
			<iframe name="shaizi" src="shaizi.jsp" style="width:940px; height:650px;"></iframe>
		</div><!-- three_col/#left -->
		<div class="clear"></div>
