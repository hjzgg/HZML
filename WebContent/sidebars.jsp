...
<title>Sidebars - 关于 Us | ChillyBlues Web Builders</title>
...
<body>
	<div class="container_16" id="main">
		...
		<div class="grid_16" id="navigation">
			<ul>
				...
				<li><a href="关于.jsp" class="current"><span>关于</span></a></li>
	...
	<div class="container_16" id="content">
		...
		<div class="grid_11 content" id="two_col">
			...
			The ChillyBlues theme with three default types of content for the sidebar:
			</p>
			<ul>
				<li>News &amp; Events</li>
			...
			<h3>News &amp; Events</h3>
			<p>
			Could show three recent posts from your blog or items from your news section
			</p>
			<h3>Connect with us</h3>
			<p>
			Displays an RSS icon, an newsletter icon and a Twitter icon.
			</p>
			<h3>Testimonials</h3>
			<p>
			Displays a number of testimonials or other quotes (uses the JQuery Cycle plugin).
			</p>
		</div><!-- /#two_col -->
