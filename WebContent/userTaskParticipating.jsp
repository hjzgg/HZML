	...
	<div class="container_16" id="content">
		...
		<div class="grid_11 content" id="two_col">
			...
			<div style="margin-top: 20px">
				<%if(pageCur!=1){%>
					  <a href="javascript:void(0)" class="button_page" onclick="myGoTo('userRequest?userRequest=userTaskParticipating&page=<%=pageCur-1%>')"><span>上一页</span></a>	
		         <%}%>
		         <% 
		         	int j;
		             ...
		             <%} else {%>
		              	  <a href="javascript:void(0)" class="button_page" onclick="myGoTo('userRequest?userRequest=userTaskParticipating&page=<%=i%>')"><span><%=i%></span></a>	
		             <%}%>
		         <% } %>                
		
		         <%if(pageCur!=pageTot){%>
		                 <a href="javascript:void(0)" class="button_page" onclick="myGoTo('userRequest?userRequest=userTaskParticipating&page=<%=pageCur+1%>')"><span>下一页</span></a>
		         <%}%>
		          <b class="pageword">
		                  &nbsp;&nbsp;共<%=pageTot%>页&nbsp;&nbsp;
		          </b>
		          ...
		          <a href="javascript:void(0)" class="button_page" onclick="myDumpTo('<%=pageTot%>', 'userRequest?userRequest=userTaskParticipating&page=')"><span>跳转</span></a>
	          </div>
		  <!-- 加入分页的按钮  -->
		</div><!-- /#two_col -->
